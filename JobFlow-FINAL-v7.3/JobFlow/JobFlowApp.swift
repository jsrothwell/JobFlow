...
class JobStore: ObservableObject {
    ...
    @Published var undoStack: [(action: String, undo: () -> Void)] = []
    @Published var showOnboarding: Bool = UserDefaults.standard.bool(forKey: "hasCompletedOnboarding") == false
    
    func performUndoableAction(_ actionName: String, undo: @escaping () -> Void) {
        undoStack.append((actionName, undo))
